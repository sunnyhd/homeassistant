...
if operation not in [ATTR_OP_SAVE, ATTR_OP_RESTORE]:
    logger.error("Invalid operation. Expected {} or {}, got: {}".format(ATTR_OP_SAVE, ATTR_OP_RESTORE, operation))
else:
    ...
    entity_ids = hass.states.entity_ids("switch") + hass.states.entity_ids("light")
